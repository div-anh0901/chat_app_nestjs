...
import { MediaConnection, DataConnection, Peer } from "peerjs";
...
export const callSlice = createSlice({
    ...
    reducers: {
        ...
        setLocalStream: (state, action: PayloadAction<MediaStream>) => {
            state.localSream = action.payload;
        }

    }
});

export const { setIsCalling, setPeer, setCall, setConnection, setIsReceivingCall, setCaller, setRemoteStream, setLocalStream } = callSlice.actions;
