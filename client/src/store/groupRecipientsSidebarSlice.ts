...
export const groupRecipientSidebarSlice = createSlice({
    ...
    reducers: {
        ...
        setContextMenuLocaltion: (state, action: PayloadAction<Points>) => {
...
export const { toggleSidebar,setSelectedUser,toggleContextMenu,setContextMenuLocaltion } = groupRecipientSidebarSlice.actions;
