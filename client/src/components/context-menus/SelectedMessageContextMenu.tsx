...
import { setIsEditing, setSelectedBeingEdited } from "../../store/messageContainerSlice";
...
export const SelectedMessageContextMenu = () => {
  ...
  const editMessage = () => {
    ...
    dispatch(setSelectedBeingEdited(message));
  }
  ...
  return (
    <>
      ...
      <ContextMenu top={points.y} left={points.x}>
        ...
        {message?.author.id === user?.id && <ContextMenuItem onClick={editMessage}>Edit</ContextMenuItem>}
      </ContextMenu>
    </>
