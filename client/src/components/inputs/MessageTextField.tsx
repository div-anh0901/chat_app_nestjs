import { useState, Dispatch, FC, SetStateAction, useRef } from 'react';
...
import { MessageTextarea } from '../../utils/inputs/Textarea';
...
export const MessageTextField: FC<Props> = ({
    message, setMessage, maxLength, setIsMultiLine, sendTypingStatus, sendMessage
}) => {
