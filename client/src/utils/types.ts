...
export type UserContextMenuActionType = 'kick' | 'transfer_ower' | 'profile';
...
export type AddGroupMessagePayload = {
    group: Group;
    user: User;
}
...
export type FriendRequestState = 'accepted' | 'pending' | 'rejected';
...
export type UserSidebarRouteType = 'conversations' | 'friends' | 'connections' | 'settings' | 'calls';
...
export type AccepteVideoCallPayload = {
    acceptor: User;
    caller: User;
    conversation: Conversation;
}
