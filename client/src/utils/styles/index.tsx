...
import { CharaterLimitProps, ContextMenuProps, ConversationSelectedProps, ConversationSidebarItemProps, InputContainerProps, MessageInputContainerProps, MessageItemContentProps, PageProps, SidebarItemProps } from "./styleTypes";
export const SIDER_BAR = 400;
...
export const InputContaineHeader = styled.div`
  display: flex;
  width: 100%;
...
export const MessageItemDetails = styled.div` flex: 1;`;
...
export const GroupRecipientsSidebarStyle = styled.div`
  display: flex;
  flex-direction: column;
  height: 100%;
  width: 350px;
...
export const CharacterLimit= styled.span<CharaterLimitProps>`
  position: absolute;
  bottom: 8px;
  right: 36px;
  font-size: 14px;
